...
class EnterKeySpeedGame:
    ...
    def _create_widgets(self):
        ...
        # Основной фрейм
        self.frame = tk.Frame(self.root, bg="#4a90e2", bd=10, relief="ridge", highlightthickness=3, highlightbackground="#2980b9")
        ...
        # Область для графика
        self.graph_frame = tk.Frame(self.root, bg="#f4f7fc")
    ...
    def start_round(self):
        ...
        self.indicator_label.config(bg="#7f8c8d", text="ПОДОЖДИТЕ")
    ...
    def activate_round(self):
        ...
        self.indicator_label.config(bg="#e74c3c", text="НАЖМИ ENTER")
    ...
    def end_game(self):
        ...
        self.indicator_label.config(bg="#7f8c8d", text="ИГРА ЗАВЕРШЕНА")
        ...
        plot.bar(rounds, self.clicks_per_round, color='#1abc9c', alpha=0.7)
        plot.plot(rounds, self.clicks_per_round, 'ro-')
        plot.axhline(y=avg_clicks, color='#2980b9', linestyle='--', alpha=0.7,
